...
> **HARD GATE:** Task 1 (ADR-0010, the API-freeze + reproducibility + dogfooded-supply-chain release policy) MUST be written AND human-reviewed/approved BEFORE any pipeline/CI task (2+) begins. The spec (`docs/superpowers/specs/2026-05-16-08-v1-release-cut-design.md`) ties three independent honesty commitments (API freeze, reproducibility-or-fail, no-overclaim announce) to one decision record; that record gates the release machinery.
