...
func NewLogger(t testing.TB, options ...LoggerOption) *slog.Logger {
	...
	logger, err := slogapp.NewLogger(os.Stderr, loggerOptions.logLevel, appext2.LogFormatText)
...
func WithLogLevel(logLevel appext2.LogLevel) LoggerOption {
...
type loggerOptions struct {
	logLevel appext2.LogLevel
}

func newLoggerOptions() *loggerOptions {
	return &loggerOptions{
		logLevel: appext2.LogLevelDebug,
	}
}
