...
import (
	...
	"github.com/inovacc/omni/pkg/buf/pkg/standard/xos/xexec"
...
func (c *cloner) CloneToBucket(
	ctx context.Context,
	envContainer app2.EnvContainer,
	url string,
	depth uint32,
	writeBucket storage2.WriteBucket,
	...
	envContainer = app2.NewEnvContainerWithOverrides(envContainer, map[string]string{
	...
	if err := xexec.Run(
		...
		"git",
		xexec.WithArgs("init"),
		xexec.WithEnv(app2.Environ(envContainer)),
...
func (c *cloner) getArgsForHTTPSCommand(envContainer app2.EnvContainer) ([]string, error) {
...
func (c *cloner) getEnvContainerWithGitSSHCommand(envContainer app2.EnvContainer) (app2.EnvContainer, error) {
	...
	if gitSSHCommand != "" {
		...
		return app2.NewEnvContainerWithOverrides(
			envContainer,
			map[string]string{
...
func (c *cloner) getGitSSHCommand(envContainer app2.EnvContainer) (string, error) {
