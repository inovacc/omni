...
import (
	...
	protoyaml2 "github.com/inovacc/omni/pkg/buf/pkg/protoyaml"
	testv2 "github.com/inovacc/omni/pkg/buf/pkg/protoyaml/internal/gen/proto/buf/protoyaml/test/v1"
...
func GenGoldenContent(filePath string, data []byte) (string, error) {
	...
	options := protoyaml2.UnmarshalOptions{
	...
	opts := protoyaml2.MarshalOptions{
		UseProtoNames: true,
	}
