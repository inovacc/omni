...
import (
	...
	cel2 "github.com/inovacc/omni/pkg/buf/pkg/protovalidate/cel"
...
func checkCELForField(
	...
	celEnv, err = celEnv.Extend(
		append(
			cel2.RequiredEnvOptions(fieldDescriptor),
			cel.Variable("this", cel2.ProtoFieldToType(fieldDescriptor, false, forItems)),
		)...,
	)
	if err != nil {
		return err
