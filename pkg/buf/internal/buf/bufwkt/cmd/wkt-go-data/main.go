...
import (
	...
	"github.com/inovacc/omni/pkg/buf/pkg/slogapp"
...
func main() {
	...
	appcmd2.Main(context.Background(), newCommand())
}

func newCommand() *appcmd2.Command {
	flags := newFlags()
...
func run(ctx context.Context, container appext.Container, flags *flags) error {
	...
	if protobufVersion == "" {
		return appcmd2.NewInvalidArgumentErrorf("--%s is required", protobufVersionFlagName)
	}
...
func getPathToData(ctx context.Context, bucket storage2.ReadBucket) (map[string][]byte, error) {
