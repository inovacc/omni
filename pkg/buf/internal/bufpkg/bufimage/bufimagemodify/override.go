...
func stringOverrideFromConfig(
	...
	valueFileOption bufconfig2.FileOption,
	prefixFileOption bufconfig2.FileOption,
	suffixFileOption bufconfig2.FileOption,
...
func javaOuterClassnameValue(imageFile bufimage.ImageFile) string {
	return xstrings.ToPascalCase(normalpath2.Base(imageFile.Path()))
}
