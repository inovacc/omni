...
import (
	...
	"github.com/inovacc/omni/pkg/buf/internal/bufpkg/bufimage/bufimagetesting"
...
func TestModifyImage(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(false, nil, nil),
			filePathToExpectedOptions: map[string]*descriptorpb.FileOptions{
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				true,
				[]bufconfig2.ManagedDisableRule{},
				[]bufconfig2.ManagedOverrideRule{},
			),
			filePathToExpectedOptions: map[string]*descriptorpb.FileOptions{
...
func TestModifyImageFile(
	...
	testcases := []struct {
		...
		dirPathToFullName                     map[string]string
		config                                bufconfig2.GenerateManagedConfig
		modifyFunc                            func(internal.MarkSweeper, bufimage.ImageFile, bufconfig2.GenerateManagedConfig, ...ModifyOption) error
		filePathToExpectedOptions             map[string]*descriptorpb.FileOptions
	...
	}{
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				...
				[]bufconfig2.ManagedDisableRule{},
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "buf.build/acme/bar", bufconfig2.FileOptionCcEnableArenas, false),
				},
			),
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				true,
				[]bufconfig2.ManagedDisableRule{
					newTestManagedDisableRule(t, "foo_empty/with_package.proto", "", "", bufconfig2.FileOptionCsharpNamespacePrefix, bufconfig2.FieldOptionUnspecified),
				},
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "bar_empty", "buf.build/acme/bar", bufconfig2.FileOptionCsharpNamespacePrefix, "BarPrefix"),
					newTestFileOptionOverrideRule(t, "bar_empty/without_package.proto", "buf.build/acme/bar", bufconfig2.FileOptionCsharpNamespace, "BarValue"),
					newTestFileOptionOverrideRule(t, "", "buf.build/acme/foo", bufconfig2.FileOptionCsharpNamespace, "FooValue"),
					newTestFileOptionOverrideRule(t, "foo_empty", "buf.build/acme/foo", bufconfig2.FileOptionCsharpNamespacePrefix, "FooPrefix"),
				},
			),
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				true,
				[]bufconfig2.ManagedDisableRule{
					newTestManagedDisableRule(t, "foo_empty/with_package.proto", "", "", bufconfig2.FileOptionGoPackagePrefix, bufconfig2.FieldOptionUnspecified),
				},
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "bar_empty", "buf.build/acme/bar", bufconfig2.FileOptionGoPackagePrefix, "barprefix"),
					newTestFileOptionOverrideRule(t, "bar_empty/without_package.proto", "buf.build/acme/bar", bufconfig2.FileOptionGoPackage, "barvalue"),
					newTestFileOptionOverrideRule(t, "foo_empty/with_package.proto", "buf.build/acme/foo", bufconfig2.FileOptionGoPackage, "foovalue"),
					newTestFileOptionOverrideRule(t, "foo_empty", "buf.build/acme/foo", bufconfig2.FileOptionGoPackagePrefix, "fooprefix"),
				},
			),
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				true,
				[]bufconfig2.ManagedDisableRule{
					newTestManagedDisableRule(t, "bar_empty", "", "", bufconfig2.FileOptionJavaPackagePrefix, bufconfig2.FieldOptionUnspecified),
				},
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "buf.build/acme/bar", bufconfig2.FileOptionJavaPackagePrefix, "barprefix"),
					newTestFileOptionOverrideRule(t, "", "buf.build/acme/foo", bufconfig2.FileOptionJavaPackageSuffix, "foosuffix"),
				},
			),
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				true,
				[]bufconfig2.ManagedDisableRule{
					newTestManagedDisableRule(t, "bar_empty", "", "", bufconfig2.FileOptionJavaPackageSuffix, bufconfig2.FieldOptionUnspecified),
				},
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "", bufconfig2.FileOptionJavaPackageSuffix, "suffix"),
				},
			),
			modifyFunc: modifyJavaPackage,
			filePathToExpectedOptions: map[string]*descriptorpb.FileOptions{
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				true,
				[]bufconfig2.ManagedDisableRule{
					newTestManagedDisableRule(t, "bar_empty", "", "", bufconfig2.FileOptionJavaPackage, bufconfig2.FieldOptionUnspecified),
				},
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "buf.build/acme/bar", bufconfig2.FileOptionJavaPackage, "bar.value"),
					newTestFileOptionOverrideRule(t, "", "buf.build/acme/foo", bufconfig2.FileOptionJavaPackage, "foo.value"),
				},
			),
			modifyFunc: modifyJavaPackage,
			filePathToExpectedOptions: map[string]*descriptorpb.FileOptions{
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				true,
				[]bufconfig2.ManagedDisableRule{
					newTestManagedDisableRule(t, "foo_empty/with_package.proto", "", "", bufconfig2.FileOptionObjcClassPrefix, bufconfig2.FieldOptionUnspecified),
				},
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "buf.build/acme/bar", bufconfig2.FileOptionObjcClassPrefix, "BAR"),
					newTestFileOptionOverrideRule(t, "", "buf.build/acme/foo", bufconfig2.FileOptionObjcClassPrefix, "FOO"),
					newTestFileOptionOverrideRule(t, "foo_all", "buf.build/acme/foo", bufconfig2.FileOptionObjcClassPrefix, "FOOALL"),
				},
			),
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				true,
				[]bufconfig2.ManagedDisableRule{
					newTestManagedDisableRule(t, "foo_empty/with_package.proto", "", "", bufconfig2.FileOptionSwiftPrefix, bufconfig2.FieldOptionUnspecified),
				},
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "buf.build/acme/bar", bufconfig2.FileOptionSwiftPrefix, "BAR"),
					newTestFileOptionOverrideRule(t, "", "buf.build/acme/foo", bufconfig2.FileOptionSwiftPrefix, "FOO"),
					newTestFileOptionOverrideRule(t, "foo_all", "buf.build/acme/foo", bufconfig2.FileOptionSwiftPrefix, "FOOALL"),
				},
			),
	...
	testcases := []struct {
	...
	}{
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				...
				[]bufconfig2.ManagedDisableRule{},
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "", bufconfig2.FileOptionJavaPackage, "value"),
				},
			),
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				...
				[]bufconfig2.ManagedDisableRule{},
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "", bufconfig2.FileOptionJavaPackagePrefix, "prefix"),
				},
			),
			imageFile:        testGetImageFile(t, "a.proto", "buf.build/foo/bar"),
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				...
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "", bufconfig2.FileOptionJavaPackagePrefix, "prefix"),
					newTestFileOptionOverrideRule(t, "", "", bufconfig2.FileOptionJavaPackagePrefix, "prefix2"),
				},
			),
			imageFile:        testGetImageFile(t, "a.proto", "buf.build/foo/bar"),
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				...
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "", bufconfig2.FileOptionJavaPackageSuffix, "suffix"),
					newTestFileOptionOverrideRule(t, "", "", bufconfig2.FileOptionJavaPackageSuffix, "suffix2"),
				},
			),
			imageFile:        testGetImageFile(t, "a.proto", "buf.build/foo/bar"),
		...
		},
		{
			...
			config: bufconfig2.NewGenerateManagedConfig(
				...
				[]bufconfig2.ManagedOverrideRule{
					newTestFileOptionOverrideRule(t, "", "", bufconfig2.FileOptionJavaPackage, "value"),
					newTestFileOptionOverrideRule(t, "", "", bufconfig2.FileOptionJavaPackage, "value2"),
				},
			),
			imageFile:        testGetImageFile(t, "a.proto", "buf.build/foo/bar"),
	...
	for _, testcase := range testcases {
		t.Run(testcase.description, func(t *testing.T) {
			...
			override, err := stringOverrideFromConfig(
				...
				bufconfig2.FileOptionJavaPackage,
				bufconfig2.FileOptionJavaPackagePrefix,
				bufconfig2.FileOptionJavaPackageSuffix,
			)
			require.NoError(t, err)
...
func newTestManagedDisableRule(
	...
	fieldOption bufconfig2.FieldOption,
) bufconfig2.ManagedDisableRule {
	disable, err := bufconfig2.NewManagedDisableRule(
		path,
		moduleFullName,
		fieldName,
		fileOption,
...
func newTestFileOptionOverrideRule(
	...
	fileOptionOverride, err := bufconfig2.NewManagedOverrideRuleForFileOption(
		path,
		moduleFullName,
		fileOption,
		value,
