...
func modifyJavaOuterClass(
	...
	return modifyStringOption(
		...
		bufconfig2.FileOptionJavaOuterClassname,
		bufconfig2.FileOptionUnspecified,
		bufconfig2.FileOptionUnspecified,
...
func modifyGoPackage(
	...
	return modifyStringOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionGoPackage,
		bufconfig2.FileOptionGoPackagePrefix,
		bufconfig2.FileOptionUnspecified,
		func(bufimage.ImageFile) stringOverrideOptions {
...
func modifyObjcClassPrefix(
	...
	return modifyStringOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionObjcClassPrefix,
		bufconfig2.FileOptionUnspecified,
		bufconfig2.FileOptionUnspecified,
		func(bufimage.ImageFile) stringOverrideOptions {
...
func modifyCsharpNamespace(
	...
	return modifyStringOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionCsharpNamespace,
		bufconfig2.FileOptionCsharpNamespacePrefix,
		bufconfig2.FileOptionUnspecified,
		func(bufimage.ImageFile) stringOverrideOptions {
...
func modifyPhpNamespace(
	...
	return modifyStringOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionPhpNamespace,
		bufconfig2.FileOptionUnspecified,
		bufconfig2.FileOptionUnspecified,
		func(bufimage.ImageFile) stringOverrideOptions {
...
func modifyPhpMetadataNamespace(
	...
	return modifyStringOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionPhpMetadataNamespace,
		bufconfig2.FileOptionUnspecified,
		bufconfig2.FileOptionPhpMetadataNamespaceSuffix,
		func(bufimage.ImageFile) stringOverrideOptions {
...
func modifyRubyPackage(
	...
	return modifyStringOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionRubyPackage,
		bufconfig2.FileOptionUnspecified,
		bufconfig2.FileOptionRubyPackageSuffix,
		func(bufimage.ImageFile) stringOverrideOptions {
...
func modifySwiftPrefix(
	...
	return modifyStringOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionSwiftPrefix,
		bufconfig2.FileOptionUnspecified,
		bufconfig2.FileOptionUnspecified,
		func(bufimage.ImageFile) stringOverrideOptions {
			return stringOverrideOptions{}
...
func modifyCcEnableArenas(
	...
	return modifyFileOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionCcEnableArenas,
		true,
		func(options *descriptorpb.FileOptions) bool {
...
func modifyJavaMultipleFiles(
	...
	return modifyFileOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionJavaMultipleFiles,
		true,
		func(options *descriptorpb.FileOptions) bool {
...
func modifyJavaStringCheckUtf8(
	...
	return modifyFileOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionJavaStringCheckUtf8,
		false,
		func(options *descriptorpb.FileOptions) bool {
...
func modifyOptimizeFor(
	...
	return modifyFileOption(
		...
		config,
		modifyOptions.preserveExisting,
		bufconfig2.FileOptionOptimizeFor,
...
func modifyStringOption(
	...
	config bufconfig2.GenerateManagedConfig,
	preserveExisting bool,
	valueOption bufconfig2.FileOption,
	prefixOption bufconfig2.FileOption,
	suffixOption bufconfig2.FileOption,
