...
func logDebugModuleKey(ctx context.Context, logger *slog.Logger, moduleKey bufmodule2.ModuleKey, message string, fields ...any) {
	logger.DebugContext(
		ctx,
		message,
		append(
...
func logDebugCommitKey(ctx context.Context, logger *slog.Logger, commitKey bufmodule2.CommitKey, message string, fields ...any) {
	logger.DebugContext(
		ctx,
		message,
		append(
