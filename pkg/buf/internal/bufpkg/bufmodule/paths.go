...
func getDocFilePathForStorageReadBucket(ctx context.Context, bucket storage2.ReadBucket) string {
...
func getStorageMatcher(ctx context.Context, bucket storage2.ReadBucket) storage2.Matcher {
	return storage2.MatchOr(
		storage2.MatchPathExt(".proto"),
		storage2.MatchPathEqual(licenseFilePath),
		storage2.MatchPathEqual(getDocFilePathForStorageReadBucket(ctx, bucket)),
	)
}
