...
var (
	digestTypeToV1ProtoDigestType = map[bufmodule2.DigestType]modulev1.DigestType{
		bufmodule2.DigestTypeB5: modulev1.DigestType_DIGEST_TYPE_B5,
	}
	v1ProtoDigestTypeToDigestType = map[modulev1.DigestType]bufmodule2.DigestType{
		modulev1.DigestType_DIGEST_TYPE_B5: bufmodule2.DigestTypeB5,
	}
	digestTypeToV1Beta1ProtoDigestType = map[bufmodule2.DigestType]modulev1beta1.DigestType{
		bufmodule2.DigestTypeB4: modulev1beta1.DigestType_DIGEST_TYPE_B4,
		bufmodule2.DigestTypeB5: modulev1beta1.DigestType_DIGEST_TYPE_B5,
	}
	v1beta1ProtoDigestTypeToDigestType = map[modulev1beta1.DigestType]bufmodule2.DigestType{
		modulev1beta1.DigestType_DIGEST_TYPE_B4: bufmodule2.DigestTypeB4,
		modulev1beta1.DigestType_DIGEST_TYPE_B5: bufmodule2.DigestTypeB5,
	}
...
func DigestToV1Proto(digest bufmodule2.Digest) (*modulev1.Digest, error) {
...
func DigestToV1Beta1Proto(digest bufmodule2.Digest) (*modulev1beta1.Digest, error) {
...
func moduleVisibilityToV1Proto(moduleVisibility bufmodule2.ModuleVisibility) (modulev1.ModuleVisibility, error) {
	switch moduleVisibility {
	case bufmodule2.ModuleVisibilityPublic:
		return modulev1.ModuleVisibility_MODULE_VISIBILITY_PUBLIC, nil
	case bufmodule2.ModuleVisibilityPrivate:
...
func digestTypeToV1Proto(digestType bufmodule2.DigestType) (modulev1.DigestType, error) {
...
func v1ProtoToDigestType(protoDigestType modulev1.DigestType) (bufmodule2.DigestType, error) {
...
func digestTypeToV1Beta1Proto(digestType bufmodule2.DigestType) (modulev1beta1.DigestType, error) {
...
func v1beta1ProtoToDigestType(protoDigestType modulev1beta1.DigestType) (bufmodule2.DigestType, error) {
...
func bucketToV1Beta1ProtoFiles(ctx context.Context, bucket storage2.ReadBucket) ([]*modulev1beta1.File, error) {
	...
	if err := storage2.WalkReadObjects(
		...
		bucket,
		"",
		func(readObject storage2.ReadObject) error {
...
func moduleKeyToV1ProtoResourceRef(moduleKey bufmodule2.ModuleKey) *modulev1.ResourceRef {
	return &modulev1.ResourceRef{
		Value: &modulev1.ResourceRef_Name_{
			Name: &modulev1.ResourceRef_Name{
...
func moduleKeysToV1ProtoResourceRefs(moduleKeys []bufmodule2.ModuleKey) []*modulev1.ResourceRef {
	return xslices.Map(moduleKeys, moduleKeyToV1ProtoResourceRef)
}

func moduleKeyToV1Beta1ProtoGetGraphRequestResourceRef(moduleKey bufmodule2.ModuleKey) *modulev1beta1.GetGraphRequest_ResourceRef {
...
func moduleKeysToV1Beta1ProtoGetGraphRequestResourceRefs(moduleKeys []bufmodule2.ModuleKey) []*modulev1beta1.GetGraphRequest_ResourceRef {
