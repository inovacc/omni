...
func (a *uploader) Upload(
	...
	options ...bufmodule2.UploadOption,
) ([]bufmodule2.Commit, error) {
	uploadOptions, err := bufmodule2.NewUploadOptions(options)
	if err != nil {
		return nil, err
	}

	contentModules, err := bufmodule2.ModuleSetTargetLocalModulesAndTransitiveLocalDeps(moduleSet)
	if err != nil {
		return nil, err
	}
	...
	contentModules, err = xslices.FilterError(contentModules, func(module bufmodule2.Module) (bool, error) {
	...
	v1beta1ProtoUploadRequestContents, err := xslices.MapError(
		contentModules,
		func(module bufmodule2.Module) (*modulev1beta1.UploadRequest_Content, error) {
	...
	remoteDeps, err := bufmodule2.RemoteDepsForModules(contentModules)
	if err != nil {
		return nil, err
	}
	...
	remoteDepRegistries := xslices.MapKeysToSortedSlice(
		...
		xslices.ToValuesMap(
			remoteDeps,
			func(remoteDep bufmodule2.RemoteDep) string {
...
func (a *uploader) createContentModuleIfNotExist(
	...
	contentModule bufmodule2.Module,
	createModuleVisibility bufmodule2.ModuleVisibility,
	...
	modules, err := a.validateContentModulesExist(ctx, primaryRegistry, []bufmodule2.Module{contentModule})
	if err != nil {
...
func (a *uploader) validateContentModulesExist(
	ctx context.Context,
	primaryRegistry string,
	contentModules []bufmodule2.Module,
) ([]*modulev1.Module, error) {
		...
		connect.NewRequest(
			&modulev1.GetModulesRequest{
				ModuleRefs: xslices.Map(
					contentModules,
					func(module bufmodule2.Module) *modulev1.ModuleRef {
...
func getV1Beta1ProtoUploadRequestContent(
	...
	v1beta1ProtoFiles, err := bucketToV1Beta1ProtoFiles(ctx, bufmodule2.ModuleReadBucketToStorageReadBucket(module))
	if err != nil {
		return nil, err
	}
...
func remoteDepToV1Beta1ProtoUploadRequestDepRef(
	remoteDep bufmodule2.RemoteDep,
