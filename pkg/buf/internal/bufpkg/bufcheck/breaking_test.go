...
import (
	...
	"github.com/inovacc/omni/pkg/buf/internal/bufpkg/bufanalysis/bufanalysistesting"
...
func testBreaking(
	...
	previousBucketTargeting, err := buftarget2.NewBucketTargeting(
		ctx,
		logger,
	...
	workspaceProvider := bufworkspace2.NewWorkspaceProvider(
		logger,
		bufmodule2.NopGraphProvider,
	...
	previousImage, err := bufimage.BuildImage(
		ctx,
		logger,
		bufmodule2.ModuleSetToModuleReadBucketWithOnlyProtoFiles(previousWorkspace),
	)
	require.NoError(t, err)
