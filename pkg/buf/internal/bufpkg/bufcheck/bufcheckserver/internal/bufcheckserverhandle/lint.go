...
var (
	...
	HandleLintCommentEnum = bufcheckserverutil2.NewLintEnumRuleHandler(handleLintCommentEnum)
	// HandleLintCommentEnumValue is a handle function.
	HandleLintCommentEnumValue = bufcheckserverutil2.NewLintEnumValueRuleHandler(handleLintCommentEnumValue)
	// HandleLintCommentField is a handle function.
	HandleLintCommentField = bufcheckserverutil2.NewLintFieldRuleHandler(handleLintCommentField)
	// HandleLintCommentMessage is a handle function.
	HandleLintCommentMessage = bufcheckserverutil2.NewLintMessageRuleHandler(handleLintCommentMessage)
	// HandleLintCommentOneof is a handle function.
	HandleLintCommentOneof = bufcheckserverutil2.NewLintOneofRuleHandler(handleLintCommentOneof)
	// HandleLintCommentService is a handle function.
	HandleLintCommentService = bufcheckserverutil2.NewLintServiceRuleHandler(handleLintCommentService)
	// HandleLintCommentRPC is a handle function.
	HandleLintCommentRPC = bufcheckserverutil2.NewLintMethodRuleHandler(handleLintCommentRPC)
)
...
var HandleLintDirectorySamePackage = bufcheckserverutil2.NewLintDirPathToFilesRuleHandler(handleLintDirectorySamePackage)

func handleLintDirectorySamePackage(
	responseWriter bufcheckserverutil2.ResponseWriter,
	_ bufcheckserverutil2.Request,
	dirPath string,
...
var HandleLintEnumNoAllowAlias = bufcheckserverutil2.NewLintEnumRuleHandler(handleLintEnumNoAllowAlias)
...
var HandleLintEnumPascalCase = bufcheckserverutil2.NewLintEnumRuleHandler(handleLintEnumPascalCase)
...
var HandleLintEnumFirstValueZero = bufcheckserverutil2.NewLintEnumRuleHandler(handleLintEnumFirstValueZero)
...
var HandleLintEnumValuePrefix = bufcheckserverutil2.NewLintEnumValueRuleHandler(handleLintEnumValuePrefix)
...
var HandleLintEnumValueUpperSnakeCase = bufcheckserverutil2.NewLintEnumValueRuleHandler(handleLintEnumValueUpperSnakeCase)
...
var HandleLintEnumZeroValueSuffix = bufcheckserverutil2.NewLintEnumValueRuleHandler(handleLintEnumZeroValueSuffix)
...
var HandleLintFieldLowerSnakeCase = bufcheckserverutil2.NewLintFieldRuleHandler(handleLintFieldLowerSnakeCase)
...
var HandleLintFieldNoDescriptor = bufcheckserverutil2.NewLintFieldRuleHandler(handleLintFieldNoDescriptor)
...
var HandleLintFieldNotRequired = bufcheckserverutil2.NewLintFieldRuleHandler(handleLintFieldNotRequired)
...
var HandleLintFileLowerSnakeCase = bufcheckserverutil2.NewLintFileRuleHandler(handleLintFileLowerSnakeCase)
...
var HandleLintImportNoPublic = bufcheckserverutil2.NewLintFileImportRuleHandler(handleLintImportNoPublic)
...
var HandleLintImportUsed = bufcheckserverutil2.NewLintFileImportRuleHandler(handleLintImportUsed)
...
var HandleLintMessagePascalCase = bufcheckserverutil2.NewLintMessageRuleHandler(handleLintMessagePascalCase)
...
var HandleLintOneofLowerSnakeCase = bufcheckserverutil2.NewLintOneofRuleHandler(handleLintOneofLowerSnakeCase)
...
var HandleLintPackageDefined = bufcheckserverutil2.NewLintFileRuleHandler(handleLintPackageDefined)
...
var HandleLintPackageDirectoryMatch = bufcheckserverutil2.NewLintFileRuleHandler(handleLintPackageDirectoryMatch)
...
var HandleLintPackageLowerSnakeCase = bufcheckserverutil2.NewLintFileRuleHandler(handleLintPackageLowerSnakeCase)
...
var HandleLintPackageNoImportCycle = bufcheckserverutil2.NewRuleHandler(handleLintPackageNoImportCycle)
...
var HandleLintPackageSameDirectory = bufcheckserverutil2.NewLintPackageToFilesRuleHandler(handleLintPackageSameDirectory)
...
var (
	...
	HandleLintPackageSameCsharpNamespace = bufcheckserverutil2.NewLintPackageToFilesRuleHandler(handleLintPackageSameCsharpNamespace)
	// HandleLintPackageSameGoPackage is a handle function.
	HandleLintPackageSameGoPackage = bufcheckserverutil2.NewLintPackageToFilesRuleHandler(handleLintPackageSameGoPackage)
	// HandleLintPackageSameJavaMultipleFiles is a handle function.
	HandleLintPackageSameJavaMultipleFiles = bufcheckserverutil2.NewLintPackageToFilesRuleHandler(handleLintPackageSameJavaMultipleFiles)
	// HandleLintPackageSameJavaPackage is a handle function.
	HandleLintPackageSameJavaPackage = bufcheckserverutil2.NewLintPackageToFilesRuleHandler(handleLintPackageSameJavaPackage)
	// HandleLintPackageSamePhpNamespace is a handle function.
	HandleLintPackageSamePhpNamespace = bufcheckserverutil2.NewLintPackageToFilesRuleHandler(handleLintPackageSamePhpNamespace)
	// HandleLintPackageSameRubyPackage is a handle function.
	HandleLintPackageSameRubyPackage = bufcheckserverutil2.NewLintPackageToFilesRuleHandler(handleLintPackageSameRubyPackage)
	// HandleLintPackageSameSwiftPrefix is a handle function.
	HandleLintPackageSameSwiftPrefix = bufcheckserverutil2.NewLintPackageToFilesRuleHandler(handleLintPackageSameSwiftPrefix)
)
...
var HandleLintPackageVersionSuffix = bufcheckserverutil2.NewLintFileRuleHandler(handleLintPackageVersionSuffix)
...
var HandleLintProtovalidate = bufcheckserverutil2.NewRuleHandler(handleLintProtovalidate)
...
func handleLintProtovalidate(
	...
	if err := bufcheckserverutil2.NewLintMessageRuleHandler(
		func(
...
var HandleLintRPCNoClientStreaming = bufcheckserverutil2.NewLintMethodRuleHandler(handleLintRPCNoClientStreaming)
...
var HandleLintRPCNoServerStreaming = bufcheckserverutil2.NewLintMethodRuleHandler(handleLintRPCNoServerStreaming)
...
var HandleLintRPCPascalCase = bufcheckserverutil2.NewLintMethodRuleHandler(handleLintRPCPascalCase)
...
var HandleLintRPCRequestResponseUnique = bufcheckserverutil2.NewLintFilesRuleHandler(handleLintRPCRequestResponseUnique)
...
var HandleLintRPCRequestStandardName = bufcheckserverutil2.NewLintMethodRuleHandler(handleLintRPCRequestStandardName)
...
var HandleLintRPCResponseStandardName = bufcheckserverutil2.NewLintMethodRuleHandler(handleLintRPCResponseStandardName)
...
var HandleLintServicePascalCase = bufcheckserverutil2.NewLintServiceRuleHandler(handleLintServicePascalCase)
...
var HandleLintServiceSuffix = bufcheckserverutil2.NewLintServiceRuleHandler(handleLintServiceSuffix)
...
var HandleLintStablePackageNoImportUnstable = bufcheckserverutil2.NewLintFilesRuleHandler(handleLintStablePackageNoImportUnstable)
...
var HandleLintSyntaxSpecified = bufcheckserverutil2.NewLintFileRuleHandler(handleLintSyntaxSpecified)
