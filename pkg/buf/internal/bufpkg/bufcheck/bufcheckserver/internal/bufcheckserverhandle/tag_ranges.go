...
import (
	...
	bufprotosource2 "github.com/inovacc/omni/pkg/buf/internal/bufpkg/bufprotosource"
)
...
func checkTagRanges[R bufprotosource2.TagRange](
	responseWriter bufcheckserverutil.ResponseWriter,
	rangeKind string,
	element bufprotosource2.NamedDescriptor,
	previousElement bufprotosource2.NamedDescriptor,
	previousRanges []R,
	ranges []R,
) error {
...
func classifyElementRange(element bufprotosource2.Descriptor) (elementKind string, maxTag int, err error) {
	switch element := element.(type) {
	case bufprotosource2.Message:
