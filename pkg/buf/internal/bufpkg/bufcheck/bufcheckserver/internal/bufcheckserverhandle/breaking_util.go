...
func fieldCppStringType(field bufprotosource.Field, descriptor protoreflect.FieldDescriptor) (protobuf2.CppFeatures_StringType, bool, error) {
	...
	if field.File().Edition() < descriptorpb.Edition_EDITION_2024 {
		...
		if opts != nil && opts.Ctype != nil {
			...
			case descriptorpb.FieldOptions_CORD:
				return protobuf2.CppFeatures_CORD, false, nil
			case descriptorpb.FieldOptions_STRING_PIECE:
				return protobuf2.CppFeatures_STRING, true, nil
			case descriptorpb.FieldOptions_STRING:
				return protobuf2.CppFeatures_STRING, false, nil
			default:
...
func fieldCppStringTypeLocation(field bufprotosource.Field) bufprotosource.Location {
	ext := protobuf2.E_Cpp.TypeDescriptor()
	if ext.Message() == nil {
		return nil
	}
...
func fieldJavaUTF8ValidationLocation(field bufprotosource.Field) bufprotosource.Location {
	ext := protobuf2.E_Java.TypeDescriptor()
	if ext.Message() == nil {
		return nil
	}
