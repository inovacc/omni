...
import (
	...
	"github.com/inovacc/omni/pkg/buf/internal/pkg/protosourcepath"
...
type client struct {
	logger                          *slog.Logger
	stderr                          io.Writer
	fileVersionToDefaultCheckClient map[bufconfig2.FileVersion]check.Client
...
func newClient(
	...
	return &client{
		...
		fileVersionToDefaultCheckClient: map[bufconfig2.FileVersion]check.Client{
			bufconfig2.FileVersionV1Beta1: v1beta1DefaultCheckClient,
			bufconfig2.FileVersionV1:      v1DefaultCheckClient,
			bufconfig2.FileVersionV2:      v2DefaultCheckClient,
		},
...
func (c *client) lint(
	...
	policyConfig bufconfig2.PolicyConfig,
	relatedCheckConfigs []bufconfig2.CheckConfig,
...
func (c *client) AllRules(
	ctx context.Context,
	ruleType check.RuleType,
	fileVersion bufconfig2.FileVersion,
...
func (c *client) allRulesAndCategories(
	...
	fileVersion bufconfig2.FileVersion,
	pluginConfigs []bufconfig2.PluginConfig,
	policyConfig bufconfig2.PolicyConfig, // May be nil.
	disableBuiltin bool,
) ([]Rule, []Category, error) {
...
func (c *client) getPlugins(ctx context.Context, pluginConfigs []bufconfig2.PluginConfig, policyConfig bufconfig2.PolicyConfig) ([]bufplugin2.Plugin, error) {
	...
	for index, pluginConfig := range pluginConfigs {
		...
		case bufconfig2.PluginConfigTypeLocal:
			plugin, err := bufplugin2.NewLocalPlugin(
				pluginConfig.Name(),
				pluginConfig.Args(),
			)
			if err != nil {
...
func (c *client) getPolicies(ctx context.Context, policyConfigs []bufconfig2.PolicyConfig) ([]bufpolicy2.Policy, error) {
...
func ignoreFileLocation(
	...
	if ignoreRootPaths, ok := config.IgnoreRuleIDToRootPaths[ruleID]; ok && normalpath2.MapHasEqualOrContainingPath(ignoreRootPaths, path, normalpath2.Relative) {
		return true, nil
	}
