...
type PolicyPluginKeyProvider interface {
	...
	GetPluginKeyProviderForPolicy(policyName string) bufplugin2.PluginKeyProvider
}
...
func NewStaticPolicyPluginKeyProvider(policyNameToPluginKeys map[string][]bufplugin2.PluginKey) (PolicyPluginKeyProvider, error) {
...
func (nopPolicyPluginKeyProvider) GetPluginKeyProviderForPolicy(policyName string) bufplugin2.PluginKeyProvider {
	return bufplugin2.NopPluginKeyProvider
}

type staticPolicyPluginKeyProvider struct {
	policyNameToPluginKeyProvider map[string]bufplugin2.PluginKeyProvider
}
...
func (s staticPolicyPluginKeyProvider) GetPluginKeyProviderForPolicy(policyName string) bufplugin2.PluginKeyProvider {
...
func newNopPluginKeyProviderForPolicy(policyName string) bufplugin2.PluginKeyProvider {
...
func (p *nopPluginKeyProviderForPolicy) GetPluginKeysForPluginRefs(
	context.Context,
	[]bufparse.Ref,
	bufplugin2.DigestType,
) ([]bufplugin2.PluginKey, error) {
