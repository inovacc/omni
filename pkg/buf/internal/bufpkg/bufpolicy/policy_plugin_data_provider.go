...
type PolicyPluginDataProvider interface {
	...
	GetPluginDataProviderForPolicy(policyName string) bufplugin2.PluginDataProvider
}
...
func NewStaticPolicyPluginDataProvider(policyNameToPluginDataProvider map[string]bufplugin2.PluginDataProvider) (PolicyPluginDataProvider, error) {
...
func (nopPolicyPluginDataProvider) GetPluginDataProviderForPolicy(policyName string) bufplugin2.PluginDataProvider {
	return bufplugin2.NopPluginDataProvider
}

type staticPolicyPluginDataProvider struct {
	policyNameToPluginDataProvider map[string]bufplugin2.PluginDataProvider
}

func newStaticPolicyPluginDataProvider(policyNameToPluginDataProvider map[string]bufplugin2.PluginDataProvider) (*staticPolicyPluginDataProvider, error) {
	return &staticPolicyPluginDataProvider{
		policyNameToPluginDataProvider: policyNameToPluginDataProvider,
	}, nil
}

func (s staticPolicyPluginDataProvider) GetPluginDataProviderForPolicy(policyName string) bufplugin2.PluginDataProvider {
...
func newNopPluginDataProviderForPolicy(policyName string) bufplugin2.PluginDataProvider {
