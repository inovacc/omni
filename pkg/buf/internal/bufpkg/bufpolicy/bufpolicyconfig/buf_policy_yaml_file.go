...
func (p *bufPolicyYAMLFile) FileVersion() bufconfig2.FileVersion {
	return p.fileVersion
}

func (p *bufPolicyYAMLFile) ObjectData() bufconfig2.ObjectData {
	return p.objectData
}
...
func writeBufPolicyYAMLFile(writer io.Writer, bufPolicyYAMLFile BufPolicyYAMLFile) error {
	...
	if fileVersion != bufconfig2.FileVersionV2 {
...
func validateSupportedFileVersion(fileName string, fileVersion bufconfig2.FileVersion) error {
	switch fileVersion {
...
func newUnsupportedFileVersionError(name string, fileVersion bufconfig2.FileVersion) error {
	if name == "" {
...
func getFileVersionForData(
	...
	case bufconfig2.FileVersionV1.String():
		return bufconfig2.FileVersionV1, nil
	case bufconfig2.FileVersionV2.String():
		return bufconfig2.FileVersionV2, nil
	default:
