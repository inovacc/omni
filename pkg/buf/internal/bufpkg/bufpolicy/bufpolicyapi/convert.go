...
var (
	v1beta1ProtoDigestTypeToDigestType = map[policyv1beta1.DigestType]bufpolicy2.DigestType{
		policyv1beta1.DigestType_DIGEST_TYPE_O1: bufpolicy2.DigestTypeO1,
	}
)
...
func V1Beta1ProtoToPolicyConfig(registry string, policyConfigV1Beta1 *policyv1beta1.PolicyConfig) (bufpolicy2.PolicyConfig, error) {
...
func PolicyConfigToV1Beta1Proto(policyConfig bufpolicy2.PolicyConfig) (*policyv1beta1.PolicyConfig, error) {
	pluginConfigs, err := xslices.MapError(
		policyConfig.PluginConfigs(),
		func(pluginConfig bufpolicy2.PluginConfig) (*policyv1beta1.PolicyConfig_CheckPluginConfig, error) {
...
func policyVisibilityToV1Beta1Proto(policyVisibility bufpolicy2.PolicyVisibility) (policyv1beta1.PolicyVisibility, error) {
	switch policyVisibility {
	case bufpolicy2.PolicyVisibilityPublic:
		return policyv1beta1.PolicyVisibility_POLICY_VISIBILITY_PUBLIC, nil
	case bufpolicy2.PolicyVisibilityPrivate:
...
func v1beta1ProtoToDigestType(protoDigestType policyv1beta1.DigestType) (bufpolicy2.DigestType, error) {
...
) (bufpolicy2.LintConfig, error) {
	return bufpolicy2.NewLintConfig(
...
) (bufpolicy2.BreakingConfig, error) {
	return bufpolicy2.NewBreakingConfig(
