...
func handle(
	...
	container, err := bufcli2.NewAppextContainerForPluginEnv(
		pluginEnv,
		appName,
	...
	moduleConfig, pluginConfigs, allCheckConfigs, err := bufcli2.GetModuleConfigAndPluginConfigsForProtocPlugin(
		ctx,
