...
import (
	...
	"github.com/inovacc/omni/pkg/buf/internal/buf/bufconvert"
...
func run(
	...
	var fromMessageOptions []bufctl.MessageOption
	if flags.Validate {
		fromMessageOptions = append(fromMessageOptions, bufctl.WithMessageValidation())
	}
