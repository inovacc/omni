...
import (
	...
	protoplugin2 "github.com/inovacc/omni/pkg/buf/internal/protoplugin"
	"google.golang.org/protobuf/proto"
	"google.golang.org/protobuf/types/pluginpb"
)

func main() {
	protoplugin2.Main(protoplugin2.HandlerFunc(handle))
}

func handle(
	_ context.Context,
	_ protoplugin2.PluginEnv,
	responseWriter protoplugin2.ResponseWriter,
	_ protoplugin2.Request,
) error {
