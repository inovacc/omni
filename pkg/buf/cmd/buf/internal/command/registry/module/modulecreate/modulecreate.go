...
func run(
	...
	visibility, err := bufcli2.VisibilityFlagToVisibilityAllowUnspecified(flags.Visibility)
	if err != nil {
		return appcmd.WrapInvalidArgumentError(err)
	}
	...
	if err != nil {
		if connect.CodeOf(err) == connect.CodeAlreadyExists {
			return bufcli2.NewModuleNameAlreadyExistsError(moduleFullName.String())
		}
		return err
	}
