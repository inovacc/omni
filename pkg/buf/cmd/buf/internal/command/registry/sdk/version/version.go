...
import (
	...
	registryv1alpha1connect2 "github.com/inovacc/omni/pkg/buf/internal/gen/proto/connect/buf/alpha/registry/v1alpha1/registryv1alpha1connect"
...
func run(
	...
	pluginCurationServiceClient := connectclient.Make(
		...
		registryv1alpha1connect2.NewPluginCurationServiceClient,
	)
	resolveServiceClient := connectclient.Make(
		clientConfig,
		moduleRef.FullName().Registry(),
		registryv1alpha1connect2.NewResolveServiceClient,
	)
	getLatestCuratedPluginResponse, err := pluginCurationServiceClient.GetLatestCuratedPlugin(
		ctx,
		connect.NewRequest(
			registryv1alpha2.GetLatestCuratedPluginRequest_builder{
	...
	moduleReference := registryv1alpha2.LocalModuleReference_builder{
		Owner:      moduleRef.FullName().Owner(),
		Repository: moduleRef.FullName().Name(),
		Reference:  moduleRef.Ref(),
	}.Build()
	pluginReference := registryv1alpha2.GetRemotePackageVersionPlugin_builder{
		Owner:   pluginIdentity.Owner(),
		Name:    pluginIdentity.Plugin(),
		Version: pluginVersion,
	}.Build()
	...
	case registryv1alpha2.PluginRegistryType_PLUGIN_REGISTRY_TYPE_GO:
		goVersionResponse, err := resolveServiceClient.GetGoVersion(
			ctx,
			connect.NewRequest(
				registryv1alpha2.GetGoVersionRequest_builder{
	...
	case registryv1alpha2.PluginRegistryType_PLUGIN_REGISTRY_TYPE_NPM:
		npmVersionResponse, err := resolveServiceClient.GetNPMVersion(
			ctx,
			connect.NewRequest(
				registryv1alpha2.GetNPMVersionRequest_builder{
					ModuleReference: moduleReference,
					PluginReference: pluginReference,
				}.Build(),
			),
	...
	case registryv1alpha2.PluginRegistryType_PLUGIN_REGISTRY_TYPE_MAVEN:
		mavenVersionResponse, err := resolveServiceClient.GetMavenVersion(
			ctx,
			connect.NewRequest(
				registryv1alpha2.GetMavenVersionRequest_builder{
					ModuleReference: moduleReference,
					PluginReference: pluginReference,
				}.Build(),
			),
	...
	case registryv1alpha2.PluginRegistryType_PLUGIN_REGISTRY_TYPE_SWIFT:
		swiftVersionResponse, err := resolveServiceClient.GetSwiftVersion(
			ctx,
			connect.NewRequest(
				registryv1alpha2.GetSwiftVersionRequest_builder{
					ModuleReference: moduleReference,
					PluginReference: pluginReference,
				}.Build(),
			),
	...
	case registryv1alpha2.PluginRegistryType_PLUGIN_REGISTRY_TYPE_PYTHON:
		pythonVersionResponse, err := resolveServiceClient.GetPythonVersion(
			ctx,
			connect.NewRequest(
				registryv1alpha2.GetPythonVersionRequest_builder{
					ModuleReference: moduleReference,
					PluginReference: pluginReference,
				}.Build(),
			),
	...
	case registryv1alpha2.PluginRegistryType_PLUGIN_REGISTRY_TYPE_CARGO:
		cargoVersionResponse, err := resolveServiceClient.GetCargoVersion(
			ctx,
			connect.NewRequest(
				registryv1alpha2.GetCargoVersionRequest_builder{
					ModuleReference: moduleReference,
					PluginReference: pluginReference,
				}.Build(),
			),
	...
	case registryv1alpha2.PluginRegistryType_PLUGIN_REGISTRY_TYPE_NUGET:
		nugetVersionResponse, err := resolveServiceClient.GetNugetVersion(
			ctx,
			connect.NewRequest(
				registryv1alpha2.GetNugetVersionRequest_builder{
					ModuleReference: moduleReference,
					PluginReference: pluginReference,
				}.Build(),
			),
	...
	case registryv1alpha2.PluginRegistryType_PLUGIN_REGISTRY_TYPE_CMAKE:
		cmakeVersionResponse, err := resolveServiceClient.GetCmakeVersion(
			ctx,
			connect.NewRequest(
				registryv1alpha2.GetCmakeVersionRequest_builder{
					ModuleReference: moduleReference,
					PluginReference: pluginReference,
				}.Build(),
			),
