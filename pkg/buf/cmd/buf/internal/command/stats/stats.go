...
import (
	...
	"github.com/inovacc/omni/pkg/buf/internal/pkg/protostat/protostatstorage"
...
func NewCommand(
	...
	return &appcmd.Command{
		...
		Long:  bufcli2.GetSourceOrModuleLong(`the source or module to get statistics for`),
	...
	stats, err := protostat.GetStats(
		...
		protostatstorage.NewFileWalker(
			bufmodule2.ModuleReadBucketToStorageReadBucket(
				bufmodule2.ModuleSetToModuleReadBucketWithOnlyProtoFilesForTargetModules(
					workspace,
				),
			),
		),
