...
import (
	...
	bufremotepluginref2 "github.com/inovacc/omni/pkg/buf/internal/bufpkg/bufremoteplugin/bufremotepluginref"
...
func run(
	...
	pluginIdentity, err := bufremotepluginref2.PluginIdentityForString(identity)
	if err != nil {
		return appcmd.WrapInvalidArgumentError(err)
	}
	if version != "" {
		if err := bufremotepluginref2.ValidatePluginVersion(version); err != nil {
			return appcmd.WrapInvalidArgumentError(err)
		}
	}
