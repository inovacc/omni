...
import (
	...
	"github.com/inovacc/omni/pkg/buf/internal/buf/bufremoteplugin/bufremotepluginconfig"
	"github.com/inovacc/omni/pkg/buf/internal/buf/bufremoteplugin/bufremoteplugindocker"
...
func (f *flags) Bind(flagSet *pflag.FlagSet) {
	...
	_ = appcmd2.MarkFlagRequired(flagSet, visibilityFlagName)
}
